  ...
  return (
    <div className='ReContainer'>
      ...
      <br/><br/><br/>
          <input
            type="text" 
            type="text" id='fname' minlength="2" maxlength="15" placeholder="First-Name" required
            name="fname"  pattern="[a-zA-Z]{2,15}"
            value={fname}
            onChange={(e) => setFName(e.target.value)}
          />
          <input
            type="text" id="lname" minlength="2" maxlength="15" placeholder="Last-Name" required
            name="lname"  pattern="[a-zA-Z]{2,15}"
            value={lname}
